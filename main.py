...
def get_paddle_speed():
    ...
    parser.add_argument('--paddle-speed', type=int, default=5, help='Paddle speed (positive integer between 1 and 20)')
    args, unknown = parser.parse_known_args()
    speed = args.paddle_speed
    if not (1 <= speed <= 20):
        print('Invalid paddle speed provided. Using default value 5.')
        return 5
    return speed
