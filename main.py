...
def get_paddle_speed():
    ...
    parser.add_argument('--paddle_speed', type=int, default=5, help='Speed of the paddle (1-20)')
    args = parser.parse_args()
    if 1 <= args.paddle_speed <= 20:
        return args.paddle_speed
    else:
        print("Invalid paddle_speed: Must be between 1 and 20. Using default value 5.")
        return 5
