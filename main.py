...
def get_valid_paddle_speed():
    try:
        ...
        # Only allow positive integers between 1 and 20 for paddle speed
        if re.fullmatch(r'([1-9]|1\d|20)', user_input):
            return int(user_input)
        else:
            raise ValueError("Invalid input: Only integers 1-20 are allowed.")
