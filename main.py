    ...
    try:
        ...
        if re.match(r'^\d+$', user_input):
            ...
            if 1 <= paddle_speed <= 20:
                ...
                print("Paddle speed must be between 1 and 20. Using default value.")
        else:
            print("Invalid input: Only positive integers are allowed. Using default value.")
    except (IndexError, ValueError):
        print("No valid input provided. Using default paddle speed.")
