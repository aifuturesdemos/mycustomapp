...
def get_valid_paddle_speed():
    try:
        ...
        # Strictly allow only positive integers between 1 and 20
        ...
        print(f"Input error: {e}. Falling back to safe default paddle speed of 5.")
        return 5  # Safe fallback default
